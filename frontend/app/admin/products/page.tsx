      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <div className="text-center md:text-left">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-white">Manage Products</h1>
            <div className="w-20 h-1 bg-gradient-to-r from-white to-transparent mt-3"></div>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 mb-8">
            <h2 className="text-3xl font-black text-white mb-6">{editingId ? '✏️ Edit Product' : '➕ Add Product'}</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-bold text-white mb-2">Stock *</label>
                <input
                  type="number"
                  required
